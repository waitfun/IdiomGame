...
class SceneGame extends eui.Component {
    ...
    public static Shared() {
	  ...
	  //对象变量
	private group_answer:eui.Group = new eui.Group();
    private group_words: eui.Group= new eui.Group();
    private img_question: eui.Image = new eui.Image();
    private btn_back: eui.Group= new eui.Group();
	private group_win:eui.Group= new eui.Group();//胜利界面的group控件
	private btn_next:eui.Button = new eui.Button();//下一个题目
